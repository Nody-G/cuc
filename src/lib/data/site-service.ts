...
export const DEFAULT_PARTNERS: SitePartner[] = [
  {
    ...
    description: 'Certification qualité nationale délivrée au titre des actions de formation. Elle atteste de la conformité du processus pédagogique (éligibilité AFDAS, France Travail, Régions).',
    order_index: 1,
    is_published: true,
  },
  {
  ...
  },
  {
    ...
    description: "Fabricant français d'équipements de protection corporelle et gilets gonflables utilisant la technologie brevetée Air Shock Absorber.",
    order_index: 3,
    is_published: true,
  },
  {
