...
/* ------------------------------------------------------------------ *
 * Ré-exports — API publique de `./server` préservée
 * ------------------------------------------------------------------ */

export { getMicrocopyOverrides } from './server-microcopy';
export { getEntityOverlays, getLocalizedSocialLinks } from './server-entities';
