...
export const InstagramStrategicBanner: React.FC<InstagramStrategicBannerProps> = ({
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 p-3.5 rounded-xl bg-gradient-to-r from-zinc-900/90 via-[#FFE500]/5 to-zinc-900/90 border border-zinc-800 text-xs font-mono-tech">
            {/* 1. Position dans le comparatif — jamais un rang national inventé */}
            <div className="flex items-center gap-2.5">
                ...
                <div>
                    <div className="text-white font-bold">Rang dans ce comparatif</div>
                    <div className="text-[10px] text-zinc-400">
                        Position calculée sur les comptes comparés, pas un rang national
                    </div>
                </div>
            </div>
                ...
                <div className="flex items-center gap-2 border-l border-zinc-800/80 pl-3">
                    ...
                    <div>
                        <div className="text-zinc-300">
                            Prochain : <strong className="text-white">@{aheadAccount.username}</strong>
                            {aheadAccount.comparativeRank ? ` (#${aheadAccount.comparativeRank})` : ''}
                        </div>
