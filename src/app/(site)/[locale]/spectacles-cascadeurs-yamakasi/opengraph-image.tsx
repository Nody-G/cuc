...
/**
 * Image Open Graph générée dynamiquement pour la route /spectacles-cascadeurs-yamakasi.
...
export default async function OpengraphImage({
    ...
    return renderOgImage(routeOgOptions("spectacles-cascadeurs-yamakasi", locale));
}
