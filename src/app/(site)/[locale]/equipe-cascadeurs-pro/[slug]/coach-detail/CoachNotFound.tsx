    ...
    <div className="min-h-screen bg-[#060608] text-white flex flex-col items-center justify-center p-4">
        ...
        <div className="text-center max-w-md my-auto">
            <h1 className="text-4xl font-display uppercase text-white mb-4">
                <span {...cucMicro('team.coachNotFoundTitle')}>{tt('coachNotFoundTitle')}</span>
            </h1>
            <p className="text-sm font-tech text-zinc-400 mb-6">
                <span {...cucMicro('team.coachNotFound')}>{tt('coachNotFound')}</span>
            </p>
            <Link
            ...
            >
                ...
                <span {...cucMicro('team.coachBackToTeam')}>{tt('coachBackToTeam')}</span>
            </Link>
        </div>
        <Footer />
    </div>
