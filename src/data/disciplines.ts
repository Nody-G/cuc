...
export const CUC_DISCIPLINES: Discipline[] = [
  ...
  },
  {
    ...
    shortDesc: 'L\'art fondamental de chuter sur sol dur, d\'encaisser les projections et de briser mobilier et verre de cinéma.',
    fullDesc: 'La chute de sa hauteur est la signature technique du cascadeur : apprendre à absorber l\'onde de choc sur les parties amortissantes du corps en préservant la tête, les articulations et les vertèbres. Le module comprend l\'apprentissage des passages à travers les baies vitrées en résine et le fracas contre du mobilier brisable de cinéma.',
