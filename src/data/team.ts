...
export const CUC_TEAM: Instructor[] = [
  ...
  },
  {
    ...
    bio: 'Cascadeur professionnel et comédien avec plus de 20 ans d\'expérience sur les tournages. Il enseigne la gestion des impacts corporels réels, la crédibilité des réactions physiques et la sécurité absolue sur les scènes d\'action au corps-à-corps.',
    notableCredits: [
