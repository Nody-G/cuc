...
**Généré le :** 2026-09-21T08:48:48.263Z
...
- **doctrine: Art du Déplacement (utiliser Parkour)** — scripts/enrich_films_and_roles.mjs:116 — `s rapprochés') .replace(/l['’]?Art du Déplacement\s*\(ADD\)/gi, 'Parkour') .repl`
- **doctrine: Art du Déplacement (utiliser Parkour)** — scripts/enrich_films_and_roles.mjs:117 — `ADD\)/gi, 'Parkour') .replace(/Art du Déplacement/gi, 'Parkour') .replace(/\bADD`
- **doctrine: acronyme ADD (utiliser Parkour)** — scripts/enrich_films_and_roles.mjs:110 — `pprochés » * - « Art du Déplacement (ADD) » → « Parkour » * - « ADD » → « Par`
- **doctrine: acronyme ADD (utiliser Parkour)** — scripts/enrich_films_and_roles.mjs:111 — `lacement (ADD) » → « Parkour » * - « ADD » → « Parkour » */ function sanitize`
- **doctrine: acronyme ADD (utiliser Parkour)** — scripts/enrich_films_and_roles.mjs:116 — `.replace(/l['’]?Art du Déplacement\s*\(ADD\)/gi, 'Parkour') .replace(/Art`
- **badge: HOLLYWOOD ACTION** — scripts/fix_doctrine_in_db.mjs:16 — `E → « Blockbuster » * • HOLLYWOOD ACTION → « Blockbuster » * * 3. JARGON`
- **badge: WORLDWIDE** — scripts/fix_doctrine_in_db.mjs:12 — `EUX (doctrine §3) — les tags marketing (WORLDWIDE, BOX-OFFICE) * sont remplacés par`
- **badge: WORLDWIDE** — scripts/fix_doctrine_in_db.mjs:14 — `r une taxonomie factuelle : * • WORLDWIDE → « Cinéma International » *`
- **badge: BOX-OFFICE** — scripts/fix_doctrine_in_db.mjs:12 — `ne §3) — les tags marketing (WORLDWIDE, BOX-OFFICE) * sont remplacés par une taxonom`
- **badge: BOX-OFFICE** — scripts/fix_doctrine_in_db.mjs:15 — `→ « Cinéma International » * • BOX-OFFICE → « Blockbuster » * • H`
- **badge: TACTIQUE** — scripts/fix_doctrine_in_db.mjs:87 — `o: '5 niveaux' }, { re: /\bRADAR\s+TACTIQUE\b/gi, to: 'Cartographie du campus' },`
- **doctrine: Art du Déplacement (utiliser Parkour)** — scripts/fix_doctrine_in_db.mjs:8 — `IE PARKOUR (doctrine §4) — « ADD » et « Art du Déplacement » * sont remplacés par « Parkour`
- **doctrine: acronyme ADD (utiliser Parkour)** — scripts/fix_doctrine_in_db.mjs:8 — `TERMINOLOGIE PARKOUR (doctrine §4) — « ADD » et « Art du Déplacement » * son`
- **doctrine: acronyme ADD (utiliser Parkour)** — scripts/fix_doctrine_in_db.mjs:71 — `s l'ordre. * * ATTENTION : la règle ADD utilise une assertion négative pour ne`
...
- **doctrine: Art du Déplacement (utiliser Parkour)** — scripts/lib/credit-curator.mjs:236 — `minologie Parkour : jamais « ADD » ni « Art du Déplacement ». [/\bADD\b/g, 'Parkour'], [`
- **doctrine: acronyme ADD (utiliser Parkour)** — scripts/lib/credit-curator.mjs:18 — `* - Terminologie Parkour : jamais « ADD » ni « Art du Déplacement ». * * Le`
- **doctrine: acronyme ADD (utiliser Parkour)** — scripts/lib/credit-curator.mjs:236 — `// Terminologie Parkour : jamais « ADD » ni « Art du Déplacement ». [/\bA`
- **doctrine: Art du Déplacement (utiliser Parkour)** — scripts/lib/credit-normalizer.mjs:11 — `CLUSIVEMENT (jamais « ADD » ni * « Art du Déplacement ») * - Aucune invention : le rôle pr`
- **doctrine: Art du Déplacement (utiliser Parkour)** — scripts/lib/credit-normalizer.mjs:138 — `ctrine éditoriale : bannit « ADD » et « Art du Déplacement ». * * @param {string} text * @re`
- **doctrine: acronyme ADD (utiliser Parkour)** — scripts/lib/credit-normalizer.mjs:10 — `r » est utilisé EXCLUSIVEMENT (jamais « ADD » ni * « Art du Déplacement ») *`
- **doctrine: acronyme ADD (utiliser Parkour)** — scripts/lib/credit-normalizer.mjs:138 — `lique la doctrine éditoriale : bannit « ADD » et « Art du Déplacement ». * * @p`
- **badge: WORLDWIDE** — scripts/migrate_all_data_to_supabase.mjs:34 — `ector: 'Jeremy Garelick', tag: 'NETFLIX WORLDWIDE' }, 'wednesday-mercredi': { year: '20`
- **badge: BOX-OFFICE** — scripts/migrate_all_data_to_supabase.mjs:57 — `s', director: 'Philippe Lacheau', tag: 'BOX-OFFICE' }, 'dunkerque-dunkirk': { year: '201`
- **badge: BOX-OFFICE** — scripts/migrate_all_data_to_supabase.mjs:60 — `Français', director: 'Dany Boon', tag: 'BOX-OFFICE' }, 'lucy': { year: '2014', category:`
- **badge: BOX-OFFICE** — scripts/migrate_all_data_to_supabase.mjs:61 — `kbuster', director: 'Luc Besson', tag: 'BOX-OFFICE MONDIAL' }, 'fast-furious-6': { year:`
- **badge: SUCCÈS MONDIAL** — scripts/migrate_all_data_to_supabase.mjs:46 — `me', director: 'Louis Leterrier', tag: 'SUCCÈS MONDIAL NETFLIX' }, 'balle-perdue': { year: '`
- **badge: EXTRÊME** — scripts/migrate_all_data_to_supabase.mjs:49 — `director: 'Michael Bay', tag: 'NETFLIX EXTRÊME' }, 'black-widow': { year: '2021', ca`
- **doctrine: acronyme ADD (utiliser Parkour)** — scripts/migration_apply_campus_pois_audit_logs.sql:42 — `e. ALTER TABLE public.site_campus_pois ADD COLUMN IF NOT EXISTS image_url TEXT; A`
...
- **doctrine: acronyme ADD (utiliser Parkour)** — scripts/migration_sync_cuc_cockpit.sql:211 — `ALTER PUBLICATION supabase_realtime ADD TABLE public.site_audit_logs; END I`
- **badge: WORLDWIDE** — scripts/normalize_film_tags_in_db.mjs:6 — `IX EXTRÊME, * SUCCÈS MONDIAL NETFLIX, WORLDWIDE, ÉLITE…) par une taxonomie factuelle`
- **badge: WORLDWIDE** — scripts/normalize_film_tags_in_db.mjs:44 — `ONDIAL NETFLIX', 'SÉRIE NETFLIX'], ['WORLDWIDE', 'CINÉMA INTERNATIONAL'], ['POLAR T`
- **badge: BOX-OFFICE** — scripts/normalize_film_tags_in_db.mjs:5 — `ce les tags marketing creux (HOLLYWOOD, BOX-OFFICE, NETFLIX EXTRÊME, * SUCCÈS MONDIAL NE`
- **badge: BOX-OFFICE** — scripts/normalize_film_tags_in_db.mjs:38 — `[ ['HOLLYWOOD', 'BLOCKBUSTER'], ['BOX-OFFICE', 'BLOCKBUSTER'], ['BOX OFFICE', 'BL`
- **badge: TACTIQUE** — scripts/normalize_film_tags_in_db.mjs:45 — `E', 'CINÉMA INTERNATIONAL'], ['POLAR TACTIQUE', 'POLAR'], ['ÉLITE', 'CURSUS DIPLÔM`
- **badge: SUCCÈS MONDIAL** — scripts/normalize_film_tags_in_db.mjs:6 — `YWOOD, BOX-OFFICE, NETFLIX EXTRÊME, * SUCCÈS MONDIAL NETFLIX, WORLDWIDE, ÉLITE…) par une tax`
- **badge: SUCCÈS MONDIAL** — scripts/normalize_film_tags_in_db.mjs:42 — `TFLIX EXTREME', 'NETFLIX ACTION'], ['SUCCÈS MONDIAL NETFLIX', 'SÉRIE NETFLIX'], ['SUCCES`
- **badge: EXTRÊME** — scripts/normalize_film_tags_in_db.mjs:5 — `g creux (HOLLYWOOD, BOX-OFFICE, NETFLIX EXTRÊME, * SUCCÈS MONDIAL NETFLIX, WORLDWIDE,`
- **badge: EXTRÊME** — scripts/normalize_film_tags_in_db.mjs:40 — `X OFFICE', 'BLOCKBUSTER'], ['NETFLIX EXTRÊME', 'NETFLIX ACTION'], ['NETFLIX EXTRE`
- **doctrine: acronyme ADD (utiliser Parkour)** — scripts/schema_navigation_footer.sql:195 — `ALTER PUBLICATION supabase_realtime ADD TABLE site_navigation; END IF;`
- **doctrine: acronyme ADD (utiliser Parkour)** — scripts/schema_navigation_footer.sql:202 — `ALTER PUBLICATION supabase_realtime ADD TABLE site_footer; END IF;`
- **doctrine: acronyme ADD (utiliser Parkour)** — scripts/schema_navigation_footer.sql:209 — `ALTER PUBLICATION supabase_realtime ADD TABLE site_social_links; END IF;`
- **doctrine: acronyme ADD (utiliser Parkour)** — scripts/schema_pages_extension.sql:118 — `ALTER PUBLICATION supabase_realtime ADD TABLE site_pages; END IF; IF N`
- **doctrine: acronyme ADD (utiliser Parkour)** — scripts/schema_pages_extension.sql:125 — `ALTER PUBLICATION supabase_realtime ADD TABLE site_partners; END IF; I`
- **doctrine: acronyme ADD (utiliser Parkour)** — scripts/schema_pages_extension.sql:132 — `ALTER PUBLICATION supabase_realtime ADD TABLE site_events; END IF; END $$;`
- **doctrine: acronyme ADD (utiliser Parkour)** — scripts/schema_page_revisions.sql:51 — `public.site_page_revisions ADD CONSTRAINT site_page_revisions_slug_num`
- **doctrine: acronyme ADD (utiliser Parkour)** — scripts/schema_page_revisions.sql:88 — `ALTER PUBLICATION supabase_realtime ADD TABLE site_page_revisions; END IF;`
- **doctrine: acronyme ADD (utiliser Parkour)** — scripts/schema_team_featured_credits.sql:16 — `=========== ALTER TABLE site_team ADD COLUMN IF NOT EXISTS featured_credits T`
- **doctrine: acronyme ADD (utiliser Parkour)** — scripts/schema_team_featured_credits.sql:19 — `}'::TEXT[]; ALTER TABLE site_team ADD COLUMN IF NOT EXISTS credits_display_li`
- **doctrine: acronyme ADD (utiliser Parkour)** — scripts/schema_team_featured_credits.sql:28 — `THEN ALTER TABLE site_team ADD CONSTRAINT site_team_credits_display_li`
- **badge: TACTIQUE** — scripts/sync_all_coach_credits_supabase.mjs:331 — `2024) — Cascadeur (Cascades physiques & tactique)', 'The Sentinels (2024) — Cascad`
- **badge: TACTIQUE** — scripts/sync_all_coach_credits_supabase.mjs:337 — `lyas': 'Cascadeur (Cascades physiques & tactique)', 'anna': 'Cascadeur' } }`
- **badge: HOLLYWOOD ACTION** — scripts/verify_doctrine_in_db.mjs:12 — `tion des faux badges marketing * (HOLLYWOOD ACTION, PRO STAFF, WORLDWIDE, BOX-OFFICE) et d`
- **badge: HOLLYWOOD ACTION** — scripts/verify_doctrine_in_db.mjs:81 — `-hollywood-action', label: 'Badge creux HOLLYWOOD ACTION', re: /hollywood\s+action/i }, { i`
- **badge: PRO STAFF** — scripts/verify_doctrine_in_db.mjs:12 — `es marketing * (HOLLYWOOD ACTION, PRO STAFF, WORLDWIDE, BOX-OFFICE) et du jargon`
- **badge: PRO STAFF** — scripts/verify_doctrine_in_db.mjs:82 — `'badge-pro-staff', label: 'Badge creux PRO STAFF', re: /\bpro\s*staff\b/i }, { id:`
- **badge: WORLDWIDE** — scripts/verify_doctrine_in_db.mjs:12 — `g * (HOLLYWOOD ACTION, PRO STAFF, WORLDWIDE, BOX-OFFICE) et du jargon * pseud`
- **badge: WORLDWIDE** — scripts/verify_doctrine_in_db.mjs:83 — `/\bpro\s*staff\b/i }, { id: 'badge-worldwide', label: 'Badge creux WORLDWIDE', re: /`
- **badge: WORLDWIDE** — scripts/verify_doctrine_in_db.mjs:83 — `'badge-worldwide', label: 'Badge creux WORLDWIDE', re: /\bworldwide\b/i }, { id: 'b`
- **badge: BOX-OFFICE** — scripts/verify_doctrine_in_db.mjs:12 — `HOLLYWOOD ACTION, PRO STAFF, WORLDWIDE, BOX-OFFICE) et du jargon * pseudo-opérationn`
- **badge: BOX-OFFICE** — scripts/verify_doctrine_in_db.mjs:84 — `: /\bworldwide\b/i }, { id: 'badge-box-office', label: 'Badge creux BOX-OFFICE', re:`
- **badge: BOX-OFFICE** — scripts/verify_doctrine_in_db.mjs:84 — `'badge-box-office', label: 'Badge creux BOX-OFFICE', re: /\bbox[\s-]?office\b/i }, {`
- **badge: TACTIQUE** — scripts/verify_doctrine_in_db.mjs:13 — `rgon * pseudo-opérationnel (RADAR TACTIQUE, HUB OPÉRATIONNEL, CURSUS ÉLITE). *`
- **badge: TACTIQUE** — scripts/verify_doctrine_in_db.mjs:85 — `?office\b/i }, { id: 'jargon-radar-tactique', label: 'Jargon RADAR TACTIQUE', re: /`
- **badge: TACTIQUE** — scripts/verify_doctrine_in_db.mjs:85 — `n-radar-tactique', label: 'Jargon RADAR TACTIQUE', re: /radar\s+tactique/i }, { id:`
- **badge: TACTIQUE** — scripts/verify_doctrine_in_db.mjs:85 — `: 'Jargon RADAR TACTIQUE', re: /radar\s+tactique/i }, { id: 'jargon-hub-operationne`
- **doctrine: Art du Déplacement (utiliser Parkour)** — scripts/verify_doctrine_in_db.mjs:8 — `diction absolue de « ADD » et * « Art du Déplacement » pour Malik Diouf et les modules d'ent`
- **doctrine: Art du Déplacement (utiliser Parkour)** — scripts/verify_doctrine_in_db.mjs:71 — `o-art-du-deplacement', label: 'Art du Déplacement (banni — utiliser « Parkour »)',`
- **doctrine: acronyme ADD (utiliser Parkour)** — scripts/verify_doctrine_in_db.mjs:7 — `octrine §4) — interdiction absolue de « ADD » et * « Art du Déplacement » pou`
- **doctrine: acronyme ADD (utiliser Parkour)** — scripts/verify_doctrine_in_db.mjs:64 — `ne pas * confondre l'acronyme banni « ADD » avec le verbe SQL « ADD » (DDL) qui p`
- **doctrine: acronyme ADD (utiliser Parkour)** — scripts/verify_doctrine_in_db.mjs:64 — `onyme banni « ADD » avec le verbe SQL « ADD » (DDL) qui peut * apparaître dans de`
- **doctrine: acronyme ADD (utiliser Parkour)** — scripts/verify_doctrine_in_db.mjs:76 — `termino-add', label: 'Acronyme ADD (banni — utiliser « Parkour »)',`
- **cliché: cursus élite** — scripts/verify_doctrine_in_db.mjs:13 — `nnel (RADAR TACTIQUE, HUB OPÉRATIONNEL, CURSUS ÉLITE). * * Le scan est RÉCURSIF : il par`
- **cliché: cursus élite** — scripts/verify_doctrine_in_db.mjs:87 — `: 'jargon-cursus-elite', label: 'Jargon CURSUS ÉLITE', re: /cursus\s+[ée]lite/i }, { id`
- **doctrine: Art du Déplacement (utiliser Parkour)** — scripts/verify_films_enrichment.mjs:49 — `un terme banni const banned = /gun-?fu|Art du Déplacement|\bADD\b/i; const violations = films.fi`
- **doctrine: acronyme ADD (utiliser Parkour)** — scripts/verify_films_enrichment.mjs:51 — `le.log(`\nViolations doctrine (gun-fu / ADD) : ${violations.length}`); violations.`
