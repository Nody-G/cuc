...
INSERT INTO public.site_programs (
    ...
    ARRAY['Chutes de hauteur sur Airbag géant', 'Bagarre de cinéma et bruitages corporels', 'Acrobaties et franchissement d''obstacles', 'Chutes contrôlées sur praticables', 'Immersion nocturne sur le campus']::text[],
...
INSERT INTO public.site_programs (
    ...
    ARRAY['Perfectionner sa technique de Parkour et de Freerunning sur Parkour Park pro', 'Dompter la peur du vide grâce aux sauts répétés sur Airbag géant', 'Chorégraphier des combats de cinéma en binôme', 'Vivre une semaine de cohésion inoubliable sur nos infrastructures']::text[],
