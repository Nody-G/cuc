...
INSERT INTO public.site_programs (
    ...
    ARRAY['Combats chorégraphiés & Action Design', 'Chutes de hauteur (CUC Tower 21m)', 'Torche humaine (cascades en feu intégrales)', 'Câblage 3D & Harnais super-héros', 'Forces spéciales & maniement d''armes à blanc', 'Parkour & Art du déplacement (Yamakasi)', 'Cascades mécaniques & chutes d''escaliers']::text[],
    'Certification QUALIOPI & Éligibilité AFDAS',
    'Postuler au Cursus Pro',
    'https://www.campus-universcascades.com/wp-content/uploads/2024/12/21452296-CHALLENGE-EUROPE-PRODUCTIONS-Qualiopi.pdf',
    0,
    true
...
INSERT INTO public.site_programs (
    ...
    'Une plongée directe dans l''univers spectaculaire des cascades de cinéma. Dormez sur le campus, mangez avec les cascadeurs pro et apprenez les bases des chutes, des combats scéniques et du saut sur airbag géant dans une ambiance fraternelle et ultra-sécurisée.',
    ...
    'https://www.campus-universcascades.com/wp-content/uploads/2025/01/Plaquette-Week-end-Immersion-CUC.pdf',
    2,
    true
) ON CONFLICT (id) DO UPDATE SET
    title = EXCLUDED.title,
...
INSERT INTO public.site_programs (
    ...
    ARRAY['Combat de comédie & scènes dramatiques d''action', 'Chutes et réactions d''impact face caméra', 'Maniement d''armes à feu et déplacements tactiques', 'Chutes d''escalier théâtralisées', 'Tournage d''une bande démo action pour chaque artiste']::text[],
...
INSERT INTO public.site_programs (
    ...
    'https://www.campus-universcascades.com/wp-content/uploads/2026/08/Plaquette-CUC-Summer-Camp-2k27.pdf',
    4,
    true
) ON CONFLICT (id) DO UPDATE SET
    title = EXCLUDED.title,
...
INSERT INTO public.site_team (
    ...
    'https://www.campus-universcascades.com/wp-content/uploads/2017/11/2-jerome.png',
    NULL,
    NULL,
...
INSERT INTO public.site_team (
    ...
    'Référent Parkour & Art du Déplacement (ADD)',
    ARRAY['Parkour originel', 'Art du déplacement', 'Franchissement rapide', 'Mental d''acier']::text[],
    'Membre historique et co-fondateur du groupe Yamakasi qui a révolutionné le franchissement urbain mondial. Malik Diouf a conçu une méthode d''entraînement exclusive pour le CUC, adaptée à tous les niveaux, enseignant la précision millimétrée, la lecture de l''environnement et l''économie d''énergie dans l''effort.',
    ARRAY['Yamakasi (Film culte)', 'Les Fils du Vent', 'Productions Luc Besson', 'Pionnier mondial de l''Art du Déplacement']::text[],
    'https://www.campus-universcascades.com/wp-content/uploads/2017/11/3-malik.png',
    NULL,
...
INSERT INTO public.site_team (
    ...
    'https://www.campus-universcascades.com/wp-content/uploads/2017/11/4-franck.png',
    NULL,
...
INSERT INTO public.site_team (
    ...
    'https://www.campus-universcascades.com/wp-content/uploads/2020/05/13-vincent-OK.png',
    NULL,
    NULL,
...
INSERT INTO public.site_team (
    ...
    'https://www.campus-universcascades.com/wp-content/uploads/2017/11/10-kefi.png',
    NULL,
    NULL,
...
INSERT INTO public.site_team (
    ...
    'Artiste martial de renom et cascadeur chevronné, Maurice Chan maîtrise l''alliance subtile entre la rigueur physique martiale et l''humour gestuel de la comédie d''action à la Jackie Chan.',
    ARRAY['Productions Europacorp', 'Spectacles parcs à thème', 'Courts-métrages d''action primés']::text[],
    'https://www.campus-universcascades.com/wp-content/uploads/2017/11/9-maurice.png',
    NULL,
    NULL,
...
INSERT INTO public.site_team (
    ...
    'https://www.campus-universcascades.com/wp-content/uploads/2021/03/14-michel.png',
    NULL,
    NULL,
    NULL,
    7,
...
INSERT INTO public.site_team (
    ...
    'https://www.campus-universcascades.com/wp-content/uploads/2017/11/7-amadeo.png',
    NULL,
    NULL,
    NULL,
    8,
...
INSERT INTO public.site_team (
    ...
    'https://www.campus-universcascades.com/wp-content/uploads/2017/11/6-niels.png',
    NULL,
    NULL,
    NULL,
    9,
...
INSERT INTO public.site_team (
    ...
    'https://www.campus-universcascades.com/wp-content/uploads/2023/07/19-bastien.png',
    NULL,
    NULL,
    NULL,
    10,
...
INSERT INTO public.site_team (
    ...
    'https://www.campus-universcascades.com/wp-content/uploads/2024/03/21-alan-cueff.png',
    NULL,
    NULL,
    NULL,
    11,
...
INSERT INTO public.site_films (
    ...
    true,
    'https://www.campus-universcascades.com/wp-content/uploads/2024/12/The-substance.jpg',
    'FESTIVAL DE CANNES',
...
INSERT INTO public.site_films (
    ...
    true,
    'https://www.campus-universcascades.com/wp-content/uploads/2024/12/Lamour-ouf.jpg',
    'BOX-OFFICE',
...
INSERT INTO public.site_films (
    ...
    true,
    'https://www.campus-universcascades.com/wp-content/uploads/2024/12/LE-COMTE-DE-MONTECRISTO-1.jpg',
    'HISTORIQUE',
...
INSERT INTO public.site_films (
    ...
    'Blockbuster',
    'Chad Stahelski',
    'Combats de triades, gun-fu, chutes dans les 222 marches de Montmartre et cascades physiques',
    ARRAY['Keanu Reeves (Stunt Doubling Support)', 'High Table Enforcers (CUC Performers)']::text[],
    true,
    'https://www.campus-universcascades.com/wp-content/uploads/2023/03/John-Wick-4.jpg',
    'HOLLYWOOD',
...
INSERT INTO public.site_films (
    ...
    'Blockbuster',
    'John Woo',
    'Gun-fu légendaire John Woo, câblage 3D, chutes à travers cloisons et fusillades au ralenti',
    ARRAY['Nathalie Emmanuel & Omar Sy (Doublures Cascades CUC)']::text[],
    true,
    'https://www.campus-universcascades.com/wp-content/uploads/2024/12/The-Killer.jpg',
    'PEACOCK / UNIVERSAL',
...
INSERT INTO public.site_films (
    ...
    true,
    'https://www.campus-universcascades.com/wp-content/uploads/2024/12/Largo-Winch.jpg',
    'ACTION FRANÇAISE',
...
INSERT INTO public.site_films (
    ...
    'Cinéma Français',
    'Florent-Emilio Siri',
    'Combats tactiques forces spéciales, CQB (Close Quarters Battle) et fusillades rapprochées',
    ARRAY['Roschdy Zem (Cascades & Combats Rapprochés)']::text[],
    true,
    'https://www.campus-universcascades.com/wp-content/uploads/2024/12/ELYAS.jpg',
    'POLAR TACTIQUE',
...
INSERT INTO public.site_films (
    ...
    true,
    'https://www.campus-universcascades.com/wp-content/uploads/2024/12/Sous-la-seine.jpg',
    'NETFLIX WORLDWIDE',
...
INSERT INTO public.site_films (
    ...
    false,
    'https://www.campus-universcascades.com/wp-content/uploads/2017/11/9-Fast-Furious-6.jpg',
    'UNIVERSAL',
...
INSERT INTO public.site_films (
    ...
    false,
    'https://www.campus-universcascades.com/wp-content/uploads/2017/11/4-James-Bond-spectre.jpg',
    'EON PROD',
...
INSERT INTO public.site_films (
    ...
    false,
    'https://www.campus-universcascades.com/wp-content/uploads/2017/11/6-Lucy.jpg',
    'EUROPACORP',
...
INSERT INTO public.site_films (
    ...
    false,
    'https://www.campus-universcascades.com/wp-content/uploads/2017/11/1-Valerian.jpg',
    'SCIENCE-FICTION',
...
INSERT INTO public.site_films (
    ...
    false,
    'https://www.campus-universcascades.com/wp-content/uploads/2017/11/25-Dunkirk.jpg',
    'WARNER BROS',
...
INSERT INTO public.site_films (
    ...
    'Fondation mondiale du parkour et de l''Art du Déplacement (ADD), cascades urbaines en toitures',
    ARRAY['Malik Diouf (Rôle Titulaire Original & Co-fondateur CUC)']::text[],
    true,
    'https://www.campus-universcascades.com/wp-content/uploads/2017/11/18-Yamakasi.jpg',
    'ORIGINES DU PARKOUR',
